    ...
    return (
        <div className='rounded-lg p-5 shadow-2xl my-5'>
            ...
            <div className='flex justify-between my-5'>
                ...
                <button onClick={() => correctAns(question.correctAnswer)} className='ml-5 btn btn-circle btn-sm btn-primary'>
            ...
            <div className='grid grid-cols-1 gap-3 lg:w-3/5 lg:mx-auto'>
                {
                    question.options.map((option, idx) =>
                        ...
                        <button onClick={() => correctOrWrng(option)} key={idx} className='grid grid-cols-3 border-2 items-center border-indigo-600 py-2 rounded-md hover:bg-green-500 hover:text-white'>
